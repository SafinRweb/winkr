...
import { MOCK_MATCHES, MOCK_APPROACHES, MOCK_CHATS } from '@/lib/mockData'
...
export const useAuthStore = create((set) => ({
  ...
  logout:     () => set({ isLoggedIn: false, supabaseUser: null, user: null }),
...
export const useChatStore = create((set) => ({
  ...
  sendWink: (chatId, message) => set((s) => ({
    chats: s.chats.map((c) =>
      c.id !== chatId ? c : { ...c, winkSent: true, winkMessage: message }
    ),
  })),
